...
#define tuningword5 0x1AE
#define tuningword1 0x56
...
#endif
{
	...
	if (lfsr && 1)
		IOWR_ALTERA_AVALON_PIO_DATA(DDS_INCREMENT_BASE, tuningword5);
	else 
		IOWR_ALTERA_AVALON_PIO_DATA(DDS_INCREMENT_BASE, tuningword1);
